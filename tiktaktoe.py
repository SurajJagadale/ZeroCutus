...
LeftFrame=Frame(MainFrame,pady=2,padx=10,bg='Cadet Blue',bd=10,width=750,height=500,relief=RIDGE)
LeftFrame.pack(side=LEFT)

RightFrame=Frame(MainFrame,pady=2,padx=10,bg='Cadet Blue',bd=10,width=560,height=500,relief=RIDGE)
RightFrame.pack(side=RIGHT)

RightFrame1=Frame(RightFrame,pady=2,padx=10,bg='Cadet Blue',bd=10,width=560,height=200,relief=RIDGE)
RightFrame1.grid(row=0,column=0)

RightFrame2=Frame(RightFrame,pady=2,padx=10,bg='Cadet Blue',bd=10,width=560,height=200,relief=RIDGE)
...
def scorekeeper():
    if(button1['text']=="X" and button2['text']=="X" and button3['text']=="X"):
        ...
        score=(n+1)
        PlayerX.set(score)
        tkinter.messagebox.showinfo("WINNER X","You Win the Game")
    ...
    if(button1['text']=="O" and button2['text']=="O" and button3['text']=="O"):
        ...
        score=(n+1)
        PlayerO.set(score)
        tkinter.messagebox.showinfo("WINNER O","You Win the Game")
...
lblPlayerX=Label(RightFrame1,font=('arial',40,'bold'),text="Player X :",bg='Cadet Blue',pady=2,padx=2)
...
lblPlayerO=Label(RightFrame1,font=('arial',40,'bold'),text="Player O :",bg='Cadet Blue',pady=2,padx=2)
...
btnReset=Button(RightFrame2,text=" RESET", font=('Times 20 bold'),height=3,width=15,bg='gainsboro',command=reset)
btnReset.grid(row=0,column=0,sticky=S+N+E+W)

btnNew=Button(RightFrame2,text=" NEW GAME", font=('Times 20 bold'),height=3,width=15,bg='gainsboro',command=NewGame)
btnNew.grid(row=1,column=0,sticky=S+N+E+W)
